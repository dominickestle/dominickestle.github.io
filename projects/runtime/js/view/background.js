var background = function (window) {
    ...
    window.opspark.makeBackground = function(app,ground) {
        ...
        function render() {
            ...
            moon.x = 1500; //determines the x position of the moon
            moon.y = 100; //determines the y position of the moon
            moon.scaleX = 0.5; //determines the length of the moon
            moon.scaleY = 0.5; //determines the height of the moon
